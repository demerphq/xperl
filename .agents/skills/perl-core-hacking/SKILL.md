...
- When modifying a C source file, preserve the position of its opening poem or
  quotation. Only the file's include directives belong above it; keep
  declarations, functions, and other code below it.
